...
export interface CommandMessage {
  ...
  /** "mobile" = telefon okuyucusu için metin odaklı yanıt talimatı eklenir */
  replyChannel?: string;
  /** Mobil ekler: { name, type (mime), base64 } */
  attachments?: Array<{ name: string; type: string; base64: string }>;
  /** true = composer-2.5-fast; false = composer-2.5 (Edit menüsünde Fast kapalı) */
